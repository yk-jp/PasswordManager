...
const secret_refresh_expiration_time: string = process.env.JWT_REFRESH_EXPIRATION_TIME as string || '1d';

const cookie_refresh_expiration_time: number = 1 * 1000 * 60 * 60 * 24; //3 * 1000 ms(1s) * 60(s) * 60(min) * 24(hours) = 3 days  3* 1000 * 60 * 60 * 24;
const TOKEN = {
